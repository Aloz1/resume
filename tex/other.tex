\newcommand*\showaccomplishments{
    ...
    \cvitem{2018}{Cyber Security Challenge Australia (CySCA)}
    \cvitem{2017}{Cyber Security Challenge Australia (CySCA)}
...
\newcommand*\showprojects{
    ...
    \cventry{2019}{IoT Vehicle tracking system}{}{}{\hfill\httpslink{github.com/Aloz1/iot-report}}{
        ...
        \vskip .5em
        \begin{compactitem}
        \item Includes an ESP32 based GPS node and an Arduino based IMU node with BLE GATT
              communications to an edge device (raspberry pi).
        ...
        \item Firmware for nodes written in C++, edge services written in Python, web client uses
              a combination of Python, javascript and HTML, the report is written in \LaTeX.
        \end{compactitem}
    }\vskip .5em
    \cventry{2018}{Zynq Space Invaders}{}{}{\hfill\httpslink{github.com/Aloz1/Zybo-SpaceInvaders}}{
        ...
        \item Designed such that each space invader operates in their own thread/task to demonstrate
