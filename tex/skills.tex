...
\newcommand*\showkeyskills{
    ...
    \cvitem{Problem Solving}{%
        In depth troubleshooting often required at my previous workplace to ensure in house services and software remained operational. Additionally, I have completed numerous assignments and projects throughout my degree, which have called upon varying levels of problem solving ability.
    }
    \cvitem{Leadership}{
        Have been in a number of leadership roles in the past, such as an assistant leadership position in my local Scout group, and a treasury position in Swinburne's Cyber Security Club.  Additionally, I have been a participant in YMCA's Youth Lleadership Program in 2012.
    }
    \cvitem{Teamwork}{%
        I've worked in teams for numerous projects and assignments in my degree, with 
        Throughout my time at Swinburne, I have been in many team projects, where it has been essential 
    }
