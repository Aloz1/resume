...
\newcommand*\showkeyskills{
    ...
    \cvitem{Self driven}{
    A motivated individual, often found on weekends experimenting with new ideas and technologies. Topics I've experimented with include Bluetooth BLE, PXE boot, Docker, and penetration testing.}
}
