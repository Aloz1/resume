...
\begin{document}
    ...
    %
    \careerobjective{
    Electronic Engineering and Computer Science student with past experience in a systems administration role. Hard working, always striving for high quality work, and able to pick up new tools and projects relatively quickly. Seeking an engineering internship within a large, well founded company.
    }

    \showkeyskills
    \showallemploymenthist
    \showedu{\alleduentries}{programming,embedded,maths}
    \showprojects
    \showaccomplishments
