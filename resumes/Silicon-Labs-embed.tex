...
\begin{document}
    ...
    %
    \careerobjective{
    Electronic Engineering and Computer Science student with past experience in a systems administration role. Hard working, always striving for high quality work, and able to pick up new tools and projects relatively quickly. Seeking an embedded software role within an international technology company as a solid foundation to start my career.
    }

    \showkeyskills
    \showallemploymenthist
    \showedu{\alleduentries}{electronics,embedded,maths,circuits}
    \showprojects
    \showaccomplishments
