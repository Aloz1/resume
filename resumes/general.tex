...
\begin{document}
    ...
    %
    \careerobjective{
    Enthusiastic Software and Electronics Engineer. Hard working, enjoys challenges and challenging problems, always striving for quality workmanship, enjoys learning about new tools and tricks.
    }

    \showkeyskills
    %\showallemploymenthist
    \showemploymenthist{bae.graduate,bae.intern,kti.sysadmin,kti.processworker}{\allemploymenthistkeys}
    \showedu{swin.beng}{embedded,maths,circuits,proglang,testing,electronics,documentation}
    \showprojects
    %\showaccomplishments

    \alcvnoreferees
    %\alcvallreferees
    %\alcvreferees{d.dellagatta,j.watts,s.taylor}
    %\alcvreferees{j.watts,s.taylor}
\end{document}
