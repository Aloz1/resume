...
\begin{document}
    ...
    %
    \careerobjective{
    Enthusiastic Electronic Engineering and Computer Science student nearing completion of my degree. Hard working, loves challenging problems, always striving for quality workmanship, enjoys picking up new tools and tricks. Seeking an embedded software position at a unique workplace as a start to my career.
    }

    \showkeyskills
    \showallemploymenthist
    \showedu{swin.beng}{embedded,maths,circuits,proglang,testing,electronics}
    \showprojects
    \showaccomplishments
